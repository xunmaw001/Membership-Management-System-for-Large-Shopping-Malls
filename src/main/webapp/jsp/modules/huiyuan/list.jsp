    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">会员信息管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">会员信息列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">会员信息列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <label>
                                                积分
                                                <input type="text" id="jifenStartSearch" style="width: 100px;" onchange="jifenChickValue(this)"   class="form-control " placeholder="开始" aria-controls="tableId">
                                            </label>
                                                -
                                            <label>
                                                <input type="text" id="jifenEndSearch" style="width: 100px;" onchange="jifenChickValue(this)"     class="form-control" placeholder="结束" aria-controls="tableId">
                                            </label>
                                 
                                            <label>
                                                积分等级
                                                <select name="jifenTypesSelectSearch" style="width: 100px;" id="jifenTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
                                            ...
                                            <label>
                                                会员状态
                                                <select name="huiyuanTypesSelectSearch" style="width: 100px;" id="huiyuanTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //会员状态
        var huiyuanTypesCell = document.createElement('td');
        huiyuanTypesCell.innerHTML = item.huiyuanValue;
        row.appendChild(huiyuanTypesCell);
